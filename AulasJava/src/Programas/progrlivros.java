...
public class progrlivros {
	...
	public static void main(String[] args) {
		...
		System.out.println("Estou pesquisando para comprar o livro " + livros.nome + " do autor " + livros.autor +" lançado em " + livros.anoLancamento);
